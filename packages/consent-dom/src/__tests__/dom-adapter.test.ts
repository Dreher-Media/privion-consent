...
describe('DOM Adapter', () => {
  ...
  describe('Element visibility', () => {
    it('should hide elements when consent is not granted', () => {
      ...
      const analyticsDiv = container.querySelector(
        'div[privion="analytics"]'
      ) as HTMLElement
      const marketingDiv = container.querySelector(
        'div[privion="marketing"]'
      ) as HTMLElement
    ...
    it('should handle mixed conditions', () => {
      ...
      const div = container.querySelector(
        'div[privion="analytics,!marketing"]'
      ) as HTMLElement
